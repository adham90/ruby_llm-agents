...
#
# @example Basic usage
#   result = Audio::MultilangSpeaker.call(text: "Bonjour, comment allez-vous?")
#   result.audio        # => Binary audio data
#   result.save_to("french_greeting.mp3")
#
# @example Spanish content
#   result = Audio::MultilangSpeaker.call(text: "Bienvenido a nuestra plataforma")
#   result.save_to("spanish_welcome.mp3")
#
# @example Japanese content
#   result = Audio::MultilangSpeaker.call(text: "ようこそ")
