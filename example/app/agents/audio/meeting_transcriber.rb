...
#
# @example Basic usage
#   result = Audio::MeetingTranscriber.call(audio: "standup_meeting.mp3")
#   result.text           # => "Good morning everyone. Let's start with..."
#   result.duration       # => 1800.5 (30 minutes)
#   result.word_count     # => 5432
#
# @example From URL
#   result = Audio::MeetingTranscriber.call(audio: "https://zoom.us/recording/abc123.mp4")
#
# @example With tenant tracking
#   result = Audio::MeetingTranscriber.call(audio: "meeting.mp3", tenant: organization)
#
module Audio
