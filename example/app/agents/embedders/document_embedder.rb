...
#
# @example Basic usage
#   result = Embedders::DocumentEmbedder.call(text: "Ruby is a dynamic language")
#   result.vector      # => [0.123, -0.456, ...] (512 dimensions)
#   result.dimensions  # => 512
#
# @example Batch indexing
#   documents = ["doc1 content", "doc2 content", "doc3 content"]
#   result = Embedders::DocumentEmbedder.call(texts: documents)
#   result.vectors.each_with_index do |vector, idx|
#     Document.find(idx).update!(embedding: vector)
#   end
#
# @example Similarity search
#   query_result = Embedders::DocumentEmbedder.call(text: "search query")
