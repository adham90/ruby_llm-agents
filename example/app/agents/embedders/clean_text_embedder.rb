...
#   result = Embedders::CleanTextEmbedder.call(text: html)
#   # Text is cleaned to "hello world!" before embedding
#
# @example With messy whitespace
#   text = "  Multiple   spaces   and\n\nnewlines  "
#   result = Embedders::CleanTextEmbedder.call(text: text)
...
#   result = Embedders::CleanTextEmbedder.call(text: comment)
#   # Safe to embed after preprocessing
#
# @example Custom preprocessing subclass
#   class MarkdownEmbedder < Embedders::CleanTextEmbedder
#     def preprocess(text)
