...
#     end
#   RUBY
#   result = Embedders::CodeEmbedder.call(text: code)
#
# @example Code similarity search
#   query_code = "def factorial(n)\n  n <= 1 ? 1 : n * factorial(n-1)\nend"
#   query = Embedders::CodeEmbedder.call(text: query_code)
#
#   repo_code = CodeSnippet.all.pluck(:content)
#   indexed = Embedders::CodeEmbedder.call(texts: repo_code)
#
...
#
#   ruby_result = Embedders::CodeEmbedder.call(text: ruby_code)
#   js_result = Embedders::CodeEmbedder.call(text: js_code)
#
