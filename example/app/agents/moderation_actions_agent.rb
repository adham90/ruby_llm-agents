...
# Companion example: Using :warn action
#
# class SoftModerationAgent < ApplicationAgent
#   model "gpt-4o"
#
#   # :warn logs a warning but continues with the LLM call
#   moderation :input,
#     threshold: 0.5,
#     on_flagged: :warn
#
...
# Companion example: Using :log action
#
# class LoggingModerationAgent < ApplicationAgent
#   model "gpt-4o"
#
#   # :log logs at info level and continues
#   moderation :input,
#     threshold: 0.5,
#     on_flagged: :log
#
