...
#
# @example Basic usage
#   result = MultilingualTranscriber.call(audio: "call_recording.mp3")
#   result.text           # => Transcribed text
#   result.language       # => "es" (detected Spanish)
#
# @example Mixed language content
#   result = MultilingualTranscriber.call(audio: "multilingual_meeting.mp3")
#   # Handles code-switching between languages
#
# @example With metadata
#   result = MultilingualTranscriber.call(audio: "unknown_audio.mp3")
