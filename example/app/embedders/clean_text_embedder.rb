...
#   result = CleanTextEmbedder.call(text: comment)
#   # Safe to embed after preprocessing
#
# @example Custom preprocessing subclass
#   class MarkdownEmbedder < CleanTextEmbedder
#     def preprocess(text)
