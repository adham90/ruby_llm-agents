...
#
#   result = BatchEmbedder.call(texts: texts) do |batch_result, batch_idx|
...
#
#       result = BatchEmbedder.call(texts: texts) do |batch_result, idx|
#         # Update job progress
...
#   result = BatchEmbedder.call(texts: large_array, tenant: organization)
