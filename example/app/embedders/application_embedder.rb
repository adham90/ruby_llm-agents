...
#   MyEmbedder.call(texts: large_array) do |batch_result, idx|
...
#
#   # Find most similar
#   query = MyEmbedder.call(text: "search query")
#   documents = MyEmbedder.call(texts: document_texts)
...
#   MyEmbedder.call(text: "hello", tenant: organization)
#
# ============================================================================
