...
#
#   # Multiple images
#   result = MyGenerator.call(prompt: "A cat", count: 4)
#   result.images.each_with_index do |img, i|
#     img.save_to("cat_#{i}.png")
#   end
#
#   # With tenant for budget tracking
#   result = MyGenerator.call(prompt: "Logo design", tenant: organization)
#
#   # With Active Storage
#   result = MyGenerator.call(prompt: "Product photo")
