...
#
# @example Basic usage
#   result = ArticleNarrator.call(text: "Welcome to our blog post...")
...
#   ArticleNarrator.stream(text: long_article) do |chunk|
#     audio_buffer.append(chunk.audio)
#   end
#
# @example With tenant tracking
#   ArticleNarrator.call(text: content, tenant: organization)
#
