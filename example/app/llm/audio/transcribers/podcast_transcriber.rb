...
#
# @example Basic usage
#   result = Llm::Audio::PodcastTranscriber.call(audio: "episode_42.mp3")
...
#   result = Llm::Audio::PodcastTranscriber.call(audio: "interview.mp3")
#   result.segments.each do |segment|
#     puts "[#{segment.start}s] #{segment.text}"
#   end
#
# @example Searchable index
#   result = Llm::Audio::PodcastTranscriber.call(audio: "episode.mp3")
