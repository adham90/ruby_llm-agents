...
#
# @example Basic usage
#   result = Llm::Audio::MeetingTranscriber.call(audio: "standup_meeting.mp3")
#   result.text           # => "Good morning everyone. Let's start with..."
#   result.duration       # => 1800.5 (30 minutes)
#   result.word_count     # => 5432
#
# @example From URL
#   result = Llm::Audio::MeetingTranscriber.call(audio: "https://zoom.us/recording/abc123.mp4")
#
# @example With tenant tracking
#   result = Llm::Audio::MeetingTranscriber.call(audio: "meeting.mp3", tenant: organization)
#
module Llm
  module Audio
