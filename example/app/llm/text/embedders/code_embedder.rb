...
#     end
#   RUBY
#   result = Llm::Text::CodeEmbedder.call(text: code)
#
# @example Code similarity search
#   query_code = "def factorial(n)\n  n <= 1 ? 1 : n * factorial(n-1)\nend"
#   query = Llm::Text::CodeEmbedder.call(text: query_code)
#
#   repo_code = CodeSnippet.all.pluck(:content)
#   indexed = Llm::Text::CodeEmbedder.call(texts: repo_code)
#
...
#
#   ruby_result = Llm::Text::CodeEmbedder.call(text: ruby_code)
#   js_result = Llm::Text::CodeEmbedder.call(text: js_code)
#
