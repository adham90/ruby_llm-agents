...
#   query_result = Llm::Text::SearchEmbedder.call(text: "How do I configure Rails routes?")
#   # Use query_result.vector to find similar documents
#
# @example Building a search index
#   documents = Article.all.pluck(:content)
#   result = Llm::Text::SearchEmbedder.call(texts: documents)
...
#   query = Llm::Text::SearchEmbedder.call(text: user_question)
