...
#
#   result = Llm::Text::BatchEmbedder.call(texts: texts) do |batch_result, batch_idx|
...
#
#       result = Llm::Text::BatchEmbedder.call(texts: texts) do |batch_result, idx|
#         # Update job progress
...
#   result = Llm::Text::BatchEmbedder.call(texts: large_array, tenant: organization)
