...
#
# @example Basic usage
#   result = Llm::BlockBasedModerationAgent.call(message: "Hello!")
#   puts result.content
#
...
#   result = Llm::BlockBasedModerationAgent.call(message: "test message")
#
# @example Checking configuration
#   config = Llm::BlockBasedModerationAgent.moderation_config
