...
#
# Available tools:
# - Llm::CalculatorTool: Math operations
# - Llm::WeatherTool: Weather lookups
#
# @example Math question
#   Llm::ToolsAgent.call(query: "What is 25 multiplied by 4?")
...
#   Llm::ToolsAgent.call(query: "What's the weather in London? And calculate 15% of 200.")
#   # => LLM may call both tools
#
# @example Inspecting tool calls
#   result = Llm::ToolsAgent.call(query: "What's 10 + 5?")
...
module Llm
  class ToolsAgent < ApplicationAgent
    ...
    tools [Llm::CalculatorTool, Llm::WeatherTool]
