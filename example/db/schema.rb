...
ActiveRecord::Schema[8.1].define(version: 20_260_201_131_148) do
  ...
  create_table 'ruby_llm_agents_api_configurations', force: :cascade do |t|
    ...
    t.index %w[scope_type scope_id], name: 'idx_api_configs_scope', unique: true
  end
  ...
  create_table 'ruby_llm_agents_executions', force: :cascade do |t|
    ...
    t.index %w[agent_type agent_version], name: 'idx_on_agent_type_agent_version_6719e42ac5'
    t.index %w[agent_type created_at], name: 'index_ruby_llm_agents_executions_on_agent_type_and_created_at'
    t.index %w[agent_type status], name: 'index_ruby_llm_agents_executions_on_agent_type_and_status'
    ...
    t.index %w[tenant_id agent_type], name: 'index_ruby_llm_agents_executions_on_tenant_id_and_agent_type'
    t.index %w[tenant_id created_at], name: 'index_ruby_llm_agents_executions_on_tenant_id_and_created_at'
    t.index %w[tenant_id status], name: 'index_ruby_llm_agents_executions_on_tenant_id_and_status'
    t.index ['tenant_id'], name: 'index_ruby_llm_agents_executions_on_tenant_id'
    t.index %w[tenant_record_type tenant_record_id], name: 'index_ruby_llm_agents_executions_on_tenant_record'
    ...
    t.index %w[workflow_id workflow_step], name: 'idx_on_workflow_id_workflow_step_85a6d10aef'
  ...
  create_table 'ruby_llm_agents_tenants', force: :cascade do |t|
    ...
    t.index %w[tenant_record_type tenant_record_id], name: 'index_ruby_llm_agents_tenant_budgets_on_tenant_record'
  end

  add_foreign_key 'ruby_llm_agents_executions', 'ruby_llm_agents_executions', column: 'parent_execution_id',
                                                                              on_delete: :nullify
  add_foreign_key 'ruby_llm_agents_executions', 'ruby_llm_agents_executions', column: 'root_execution_id',
                                                                              on_delete: :nullify
end
