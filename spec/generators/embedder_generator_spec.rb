...
RSpec.describe RubyLlmAgents::EmbedderGenerator, type: :generator do
  describe "basic embedder generation" do
    ...
    it "creates the embedder file with correct name" do
      expect(file_exists?("app/agents/embedders/document_embedder.rb")).to be true
    end

    it "creates a class that inherits from ApplicationEmbedder" do
      content = file_content("app/agents/embedders/document_embedder.rb")
      expect(content).to include("class DocumentEmbedder < ApplicationEmbedder")
    end

    it "wraps the class in Embedders namespace" do
      content = file_content("app/agents/embedders/document_embedder.rb")
      expect(content).to include("module Embedders")
    end
  ...
  describe "combined options" do
    ...
    it "creates the embedder file" do
      expect(file_exists?("app/agents/embedders/search_embedder.rb")).to be true
    end

    it "applies all options correctly" do
      content = file_content("app/agents/embedders/search_embedder.rb")
  ...
  describe "camelCase name handling" do
    ...
    it "creates file with underscored name" do
      expect(file_exists?("app/agents/embedders/my_document_embedder.rb")).to be true
    end

    it "uses the correct class name" do
      content = file_content("app/agents/embedders/my_document_embedder.rb")
  ...
  describe "snake_case name handling" do
    ...
    it "creates file with correct name" do
      expect(file_exists?("app/agents/embedders/knowledge_base_embedder.rb")).to be true
    end

    it "uses the correct class name" do
      content = file_content("app/agents/embedders/knowledge_base_embedder.rb")
  ...
  describe "nested namespace" do
    ...
    it "creates file in nested directory" do
      expect(file_exists?("app/agents/embedders/search/document_embedder.rb")).to be true
    end

    it "uses namespaced class name" do
      content = file_content("app/agents/embedders/search/document_embedder.rb")
