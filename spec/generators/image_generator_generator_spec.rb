...
RSpec.describe RubyLlmAgents::ImageGeneratorGenerator, type: :generator do
  ...
  describe "combined options" do
    ...
    it "creates the generator file" do
      expect(file_exists?("app/agents/images/product_generator.rb")).to be true
    end

    it "applies all options correctly" do
      content = file_content("app/agents/images/product_generator.rb")
  ...
  describe "camelCase name handling" do
    ...
    it "creates file with underscored name" do
      expect(file_exists?("app/agents/images/hero_image_generator.rb")).to be true
    end

    it "uses the correct class name" do
      content = file_content("app/agents/images/hero_image_generator.rb")
  ...
  describe "snake_case name handling" do
    ...
    it "creates file with correct name" do
      expect(file_exists?("app/agents/images/product_shot_generator.rb")).to be true
    end

    it "uses the correct class name" do
      content = file_content("app/agents/images/product_shot_generator.rb")
  ...
  describe "nested namespace" do
    ...
    it "creates file in nested directory" do
      expect(file_exists?("app/agents/images/marketing/banner_generator.rb")).to be true
    end

    it "uses namespaced class name" do
      content = file_content("app/agents/images/marketing/banner_generator.rb")
